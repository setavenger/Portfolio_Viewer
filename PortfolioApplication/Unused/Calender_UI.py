...
class Calendar:
    ...
    def setup(self, y, m):
        ...
        # took out the weekday function
        # if wanted add one {} // sel = tk.Label(self.parent, height=2, text='{} {} {} {}'.format(
        # and add self.day_name to format list// self.day_name, calendar.month_name[self.month_s. .....
